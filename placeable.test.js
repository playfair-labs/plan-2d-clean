...
assert.ok(/function hideIfIdle\(/.test(html), 'opening right-click does not instantly dismiss PLACE');
assert.ok(/b\.addEventListener\('pointerdown', go\)/.test(html), 'PLACE items fire on pointerdown');
